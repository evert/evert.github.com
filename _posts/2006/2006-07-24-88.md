...
<p>The guys over at <a href="http://fluorine.thesilentgroup.com/" class="dead-link">Fluorine (an AMF server implementation for .NET</a> seem to have stuff working in their alpha builds, so I'm going to see if I can learn from their sources or maybe contact them..</a></p>
