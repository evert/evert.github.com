...
developed the initial spec of openid. [Verisign][3] also recently jumped on the
bandwagon..
...
look for &lt;link&ht; tags, which, in the case of livejournal, could look like
this:
...
instead we are going to use the [MetaDetector](http://www.rooftopsolutions.nl/code/?a=d&p=MetaDetector)
...
[/blogdetect](/blogdetect) and fill in your openid identity.
