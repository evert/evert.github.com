...
anniversary of this blog. In which I talk about PHP-related stuff 90% of the time.
...
timespan. It might also not be interesting, in which case: why are you still here?
...
* Vim.
* A borrowed Powerbook G4 running OS X Tiger.
